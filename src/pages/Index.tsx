    ...
    <main>
          ...
          <div className="h-96 md:h-[500px] relative overflow-hidden rounded-2xl group">
            ...
            <div className="absolute inset-0 flex items-end p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
              <div className="text-white transform transition-transform duration-500 group-hover:translate-y-[-10px]">
                ...
                <Link to="/shop" className="text-sm font-medium underline text-[#4ED3E0] underline-offset-4 group-hover:underline-offset-8 transition-all">
                  Explore Collection
                </Link>
              </div>
            </div>
      ...
      <section className="py-20 mb-16 rounded-t-3xl bg-secondary/50">
        <div className="container">
          <h2 className="text-3xl font-semibold text-center mb-12 text-[#4ED3E0]">Why Shop SnapStyle</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-card p-8 rounded-2xl shadow-sm hover:shadow-lg hover:shadow-[#4ED3E0]/5 transition-all duration-300 hover:-translate-y-1 border border-border/40">
              <div className="w-16 h-16 bg-secondary rounded-full flex items-center justify-center mx-auto mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#4ED3E0]">
            ...
            <div className="text-center bg-card p-8 rounded-2xl shadow-sm hover:shadow-lg hover:shadow-[#4ED3E0]/5 transition-all duration-300 hover:-translate-y-1 border border-border/40">
              ...
              <p className="text-sm text-muted-foreground">AI-powered outfit recommendations <span className="bg-[#4ED3E0]/20 text-[#4ED3E0] text-xs px-1.5 py-0.5 rounded-full ml-1">Coming Soon</span></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container py-16 mb-20">
        <div className="bg-secondary/40 rounded-2xl p-10 text-center relative overflow-hidden border border-border/30">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#4ED3E0]">Snap Your Fit</h2>
            ...
            <button className="px-8 py-4 bg-secondary rounded-xl text-[#4ED3E0]/70 cursor-not-allowed inline-flex items-center border border-[#4ED3E0]/30">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full opacity-10">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#4ED3E0]">
                <path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z" />
                <circle cx="12" cy="13" r="3" />
              </svg>
          </div>
